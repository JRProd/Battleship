...
public class ShotSelectiveRandomClusterAI extends Player{
	...
	private int[] getCoords()
	{
		...
		shotPerCluster[chosenCluster[0]][chosenCluster[1]] ++;
		
		if(Constants.DEBUG)
			System.out.println("RANDOM_CLUSTER Chosen Cluster :: " + chosenCluster[0] + " " + chosenCluster[1] + " with score of " + shotPerCluster[chosenCluster[0]][chosenCluster[1]]);
